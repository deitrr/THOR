...
__host__ void ESP::Thor(const SimulationSetup& sim, kernel_diagnostics& diag) {
    ...
    for (int rk = 0; rk < 3; rk++) {
        ...
        if (sim.HyDiff) {
            ...
            BENCH_POINT_I_S(current_step, rk, "Diffusion_Op1_mid_b4pole1", (), ("diff_d"))
            ...
            BENCH_POINT_I_S(current_step, rk, "Diffusion_Op1_mid1", (), ("diff_d"))
            // }
            ...
            BENCH_POINT_I_S(current_step, rk, "Diffusion_Op1_mid_b4pole2", (), ("diff_d"))
            ...
            BENCH_POINT_I_S(current_step, rk, "Diffusion_Op1_mid2", (), ("diff_d"))
